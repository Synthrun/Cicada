...
This keeps audit history — every run produces a new file.
...
|----------|-------|-------|-------------------|
| 🔴 **Critical** | 0 | 0 | Hardcoded secrets, SQLi, command injection, weak crypto |
| 🟠 **High** | 0 | 0 | Missing rate limiting, plaintext tokens, wildcard CORS |
| 🟡 **Medium** | 0 | 0 | No CSP, verbose errors, no CSRF |
| 🔵 **Low** | 0 | 0 | No HSTS, no MFA, unsigned commits |
| ⚪ **Info** | 0 | — | Architecture notes |
...
| Password hashing (bcrypt ≥ 10) | ✅ Proper |
...
17. **Report output** — always write reports into `cicada/` directory with timestamped filenames (`cicada/report-2026-06-29-143022.md`). Create `cicada/` if it doesn't exist. Never dump raw report.md into the project root.
